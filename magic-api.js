/*list of possible suggestion values
* https://deckbrew.com/api/ under subheading "Card Filtering"
* index0: card types
* index1: subtypes
*       index1: artifact subtypes
*       index2: creature subtypes
*       index3: enchantment subtypes
*       etc.
* index2: supertypes
* index3: name (NO SUGGESTIONS!)
* index4: oracle rules text (spaces replaced by plus signs)
* index5: set (three letter code)
* index6: rarity
* index7: color(s)
* index8: multicolor (true or false)
* index9: format
...
var suggestions = [
    ...
    [
        ...
        ["Advisor", "Ally", "Angel", "Ape", "Archer", "Artificer", "Assassin", "Avatar",
            "Barbarian", "Beast", "Berserker", "Bird", "Boar", "Cat", "Centaur", "Cleric",
            "Construct", "Demon", "Djinn", "Dragon", "Drake", "Druid", "Dryad", "Dwarf",
            "Efreet", "Elemental", "Elephant", "Elf", "Faerie", "Fish", "Fox", "Fungus",
            "Gargoyle", "Giant", "Goblin", "Golem", "Griffin", "Horror", "Horse", "Hound",
            "Human", "Hydra", "Illusion", "Imp", "Insect", "Kavu", "Kithkin", "Knight", "Kor",
            "Lizard", "Mercenary", "Merfolk", "Minion", "Minotaur", "Monk", "Mutant", "Myr",
            "Nightmare", "Nomad", "Ogre", "Ooze", "Orc", "Plant", "Rat", "Rebel", "Rhino",
            "Rogue", "Samurai", "Scarecrow", "Scout", "Serpent", "Shade", "Shaman",
            "Shapeshifter", "Skeleton", "Sliver", "Snake", "Soldier", "Spellshaper", "Sphinx",
            "Spider", "Spirit", "Thrull", "Treefolk", "Troll", "Vampire", "Vedalken", "Viashino",
            "Wall", "Warrior", "Werewolf", "Wizard", "Wolf", "Wurm", "Zombie"], //Creature Subtypes
        ["Aura", "Cartouche", "Curse"],
...
function generateSuggestions(suggestionListIndex){
    ...
    if(suggestionListIndex===1){
        var cardType = document.getElementById("data0").value;
